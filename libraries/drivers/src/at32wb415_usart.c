...
/**
  ...
  * @note   clock config are not available for UART5.
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
...
/**
  ...
  * @note   clock enable are not available for UART5.
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         USART1, USART2 or USART3.
  * @param  new_state: TRUE or FALSE
...
/**
  ...
  * @note   The guard time bits are not available for UART5.
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         USART1, USART2 or USART3.
...
/**
  ...
  * @note   the division are not available for UART5.
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         USART1, USART2 or USART3.
...
/**
  ...
  * @note   the smart card mode are not available for UART5.
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         USART1, USART2 or USART3.
...
/**
  ...
  * @note   the smart card nack are not available for UART5.
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         USART1, USART2 or USART3.
...
/**
  ...
  *         this parameter can be one of the following values:
  *         - USART_CTSCF_FLAG: cts change flag (not available for UART5)
...
/**
  ...
  *         - USART_CTSCF_FLAG: (not available for UART5).
  *         - USART_BFF_FLAG:
  *         - USART_TDC_FLAG:
  *         - USART_RDBF_FLAG:
  *         - USART_PERR_FLAG:
