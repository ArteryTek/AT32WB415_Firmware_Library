...
/**
  ...
  * @param  value
  *         this parameter can be one of the following values:
  *         - CRM_DMA1_PERIPH_CLOCK         - CRM_DMA2_PERIPH_CLOCK         - CRM_CRC_PERIPH_CLOCK         - CRM_OTGFS1_PERIPH_CLOCK
  *         - CRM_IOMUX_PERIPH_CLOCK        - CRM_GPIOA_PERIPH_CLOCK        - CRM_GPIOB_PERIPH_CLOCK       - CRM_GPIOC_PERIPH_CLOCK
  *         - CRM_GPIOD_PERIPH_CLOCK        - CRM_GPIOF_PERIPH_CLOCK        - CRM_ADC1_PERIPH_CLOCK        - CRM_TMR1_PERIPH_CLOCK
  *         - CRM_SPI2_PERIPH_CLOCK         - CRM_USART1_PERIPH_CLOCK       - CRM_TMR9_PERIPH_CLOCK        - CRM_TMR10_PERIPH_CLOCK
  *         - CRM_TMR11_PERIPH_CLOCK        - CRM_TMR2_PERIPH_CLOCK         - CRM_TMR3_PERIPH_CLOCK        - CRM_TMR4_PERIPH_CLOCK
  *         - CRM_TMR5_PERIPH_CLOCK         - CRM_TMR9_PERIPH_CLOCK         - CRM_TMR10_PERIPH_CLOCK       - CRM_TMR11_PERIPH_CLOCK
  *         - CRM_CMP_PERIPH_CLOCK          - CRM_WWDT_PERIPH_CLOCK         - CRM_USART2_PERIPH_CLOCK      - CRM_USART3_PERIPH_CLOCK
  *         - CRM_UART5_PERIPH_CLOCK        - CRM_I2C1_PERIPH_CLOCK        - CRM_CAN1_PERIPH_CLOCK         - CRM_PWC_PERIPH_CLOCK
  * @param  new_state (TRUE or FALSE)
  * @retval none
  */
...
/**
  ...
  *         - CRM_TMR1_PERIPH_RESET         - CRM_SPI2_PERIPH_RESET         - CRM_USART1_PERIPH_RESET      - CRM_TMR9_PERIPH_RESET
  ...
  *         - CRM_USART2_PERIPH_RESET       - CRM_USART3_PERIPH_RESET       - CRM_UART5_PERIPH_RESET       - CRM_I2C1_PERIPH_RESET
  *         - CRM_CAN1_PERIPH_RESET         - CRM_PWC_PERIPH_RESET          - CRM_OTGFS1_PERIPH_RESET
  * @param  new_state (TRUE or FALSE)
  * @retval none
  */
...
/**
  * @brief  enable or disable otgfs end-point3 remap, only available in at32wb415xx revision C.
  *         at32wb415xx revision B: (not support)
  *         do not support configuration ep3 remap.
  *
  *         at32wb415xx revision C: (support)
...
/**
  * @brief  usb divider reset, only available in at32wb415xx revision C.
  *         at32wb415xx revision B: (not support)
