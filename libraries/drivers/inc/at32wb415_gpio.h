/**
  **************************************************************************
  * @file     at32wb415_gpio.h
  * @version  v2.0.3
  * @date     2022-08-16
  * @brief    at32wb415 gpio header file
  **************************************************************************
...
#ifndef __AT32WB415_GPIO_H
#define __AT32WB415_GPIO_H
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved4            : 5; /* [23:19] */
      __IO uint32_t swjtag_conf          : 3; /* [26:24] */
      __IO uint32_t reserved5            : 5; /* [31:27] */
    } remap_bit;
  };
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved2            : 12;/* [19:8] */
