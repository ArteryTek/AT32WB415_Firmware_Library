...
#ifndef __AT32WB415_BOARD_H
#define __AT32WB415_BOARD_H
...
/**
  ...
  * 1. at-start-wb415 v1.x board
  * if define AT_START_WB415_V1, the header file support at-start-wb415 v1.x board
  */

#if !defined (AT_START_WB415_V1)
#error "please select first the board at-start device used in your application (in at32wb415_board.h file)"
#endif
