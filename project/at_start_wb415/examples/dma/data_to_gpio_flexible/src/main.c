...
/** @addtogroup 415_DMA_data_to_gpio_flexible DMA_data_to_gpio_flexible
  * @{
  */
...
int main(void)
{
  ...
  /* config gpioa pin for output mode */
  ...
  dma_init_struct.peripheral_base_addr = (uint32_t)&GPIOA->odt;
