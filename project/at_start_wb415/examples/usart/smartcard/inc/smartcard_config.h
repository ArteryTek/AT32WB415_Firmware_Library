...
#define SC_RESET_PIN             GPIO_PINS_13
#define SC_CMDVCC_PIN            GPIO_PINS_14
#define SC_OFF_PIN               GPIO_PINS_15
#define SC_3_5V_PORT             GPIOA
#define SC_RESET_PORT            GPIOB
#define SC_CMDVCC_PORT           GPIOB
#define SC_OFF_PORT              GPIOB
#define SC_3_5V_CLK              CRM_GPIOA_PERIPH_CLOCK
#define SC_RESET_CLK             CRM_GPIOB_PERIPH_CLOCK
#define SC_CMDVCC_CLK            CRM_GPIOB_PERIPH_CLOCK
#define SC_OFF_CLK               CRM_GPIOB_PERIPH_CLOCK
#define SC_OFF_EXINT             EXINT_LINE_15
#define SC_OFF_PORTSOURCE        GPIO_PORT_SOURCE_GPIOB
#define SC_OFF_PINSOURCE         GPIO_PINS_SOURCE15
#define SC_OFF_EXINT_IRQ         EXINT15_10_IRQn
