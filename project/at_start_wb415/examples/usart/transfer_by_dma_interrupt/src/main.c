...
/** @addtogroup 415_USART_transfer_by_dma_interrupt USART_transfer_by_dma_interrupt
  * @{
  */
...
void dma_configuration(void)
{
  ...
  /* dma1 channel4 for usart1 rx configuration */
  ...
  dma_channel_enable(DMA1_CHANNEL4, TRUE); /* usart1 rx begin dma receiving */
