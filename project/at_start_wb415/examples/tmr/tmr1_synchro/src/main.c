...
/** @addtogroup 415_TMR_tmr1_synchro TMR_tmr1_synchro
  * @{
  */
...
int main(void)
{
  ...
  tmr_trigger_input_select(TMR2, TMR_SUB_INPUT_SEL_IS0);

  /* slave mode selection: hang mode */
  tmr_sub_mode_select(TMR2, TMR_SUB_HANG_MODE);
