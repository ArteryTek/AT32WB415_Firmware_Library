/**
  ...
  */
  ...
  - div = (tim2clk / tmr2 counter clock) - 1
  and generate 4 signals with 4 different delays:
  tmr2_ch1 delay = ch1_val/tmr2 counter clock = 1000 ms
  tmr2_ch2 delay = ch2_val/tmr2 counter clock = 500 ms
  tmr2_ch3 delay = ch3_val/tmr2 counter clock = 250 ms
  tmr2_ch4 delay = ch4_val/tmr2 counter clock = 125 ms
