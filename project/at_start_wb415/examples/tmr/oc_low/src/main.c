...
/** @addtogroup 415_TMR_oc_low TMR_oc_low
  * @{
  */

tmr_output_config_type tmr_oc_init_structure;
uint16_t ch1_val = 1000;
uint16_t ch2_val = 500;
uint16_t ch3_val = 250;
uint16_t ch4_val = 125;
...
int main(void)
{
  ...
  div_value = (uint16_t)(system_core_clock / 4000) - 1;
  ...
  gpio_bits_set(GPIOB, GPIO_PINS_6 | GPIO_PINS_7 | GPIO_PINS_8 | GPIO_PINS_9);
