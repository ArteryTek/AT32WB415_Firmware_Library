...
{
  /* clear tmr2 channel interrupt pending bit */
  tmr_flag_clear(TMR2, TMR_C2_FLAG);

  /* get the input channel data value */
  ic2value = tmr_channel_value_get(TMR2, TMR_SELECT_CHANNEL_2);

  if(ic2value != 0)
  {
    /* duty cycle computation */
    duty_cycle = (tmr_channel_value_get(TMR2, TMR_SELECT_CHANNEL_1) * 100) / ic2value;
