...
/** @addtogroup 415_TMR_complementary_signals TMR_complementary_signals
  * @{
  */
...
int main(void)
{
  ...
  /* compute c2dt value to generate a duty cycle at 25%  for channel 2 and 2c */
  channel2_pulse = (uint16_t) (((uint32_t) 25 * (timer_period - 1)) / 100);

  /* compute c3dt value to generate a duty cycle at 12.5%  for channel 3 and 3c */
