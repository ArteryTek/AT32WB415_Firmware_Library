...
/** @addtogroup 415_TMR_oc_toggle_tmr4
  * @{
  */
...
/**
  * @brief  this function handles tmr4 global interrupt request.
  * @param  none
  * @retval none
  */
void TMR4_GLOBAL_IRQHandler(void)
{
  ...
  if(tmr_flag_get(TMR4, TMR_C1_FLAG) != RESET)
  {
    ...
    tmr_channel_value_set(TMR4, TMR_SELECT_CHANNEL_1, capture + ch1_val);
  }
  ...
  if(tmr_flag_get(TMR4, TMR_C2_FLAG) != RESET)
  {
    ...
    tmr_channel_value_set(TMR4, TMR_SELECT_CHANNEL_2, capture + ch2_val);
  }
