...
/** @addtogroup 415_TMR_parallel_synchro TMR_parallel_synchro
  * @{
  */
...
void gpio_configuration(void)
{
  ...
  gpio_init_struct.gpio_pins = GPIO_PINS_8 | GPIO_PINS_1;
...
int main(void)
{
  ...
  tmr_channel_value_set(TMR2, TMR_SELECT_CHANNEL_2, 72);
