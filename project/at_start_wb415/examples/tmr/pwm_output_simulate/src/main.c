...
/** @addtogroup 415_TMR_pwm_output_simulate TMR_pwm_output_simulate
  * @{
  */

tmr_output_config_type tmr_oc_init_structure;

uint16_t ch1_val = 40961;
uint16_t ch2_val = 27309;
uint16_t ch3_val = 13654;
uint16_t ch4_val = 6826;
...
int main(void)
{
  ...
  div_value = (uint16_t)(system_core_clock / 12000000) - 1;

  /* tmr2 time base configuration */
  tmr_base_init(TMR2, 65535, div_value);
