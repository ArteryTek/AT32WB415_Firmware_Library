...
/** @addtogroup 415_SPI_only_receive_mode_polling SPI_only_receive_mode_polling
  * @{
  */
...
uint8_t spi2_tx_buffer[BUFFER_SIZE] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
...
int main(void)
{
  ...
  transfer_status = buffer_compare(spi2_rx_buffer, spi2_tx_buffer, BUFFER_SIZE);
